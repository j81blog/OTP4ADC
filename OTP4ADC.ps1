...
function New-QRTOTPImage {
    ...
    Write-Verbose "Function: New-QRTOTPImage"
    $payload = @"
$($URI.AbsoluteUri)
"@
...
function Invoke-UpdateTokenText {
    Write-Verbose "Function: Invoke-UpdateTokenText"
...
function Invoke-LoadQRModule {
    ...
    Write-Verbose "Loading QR Imaging Module"
    try {
        # Version: 2.4.1
...
function Invoke-LoadAppImage {
    Write-Verbose "Function: Invoke-LoadAppImage"
